...
public class FileDemonstration extends JFrame
{
	...
	public void analyzePath()
	{
		...
		if(name.exists())
		{
			...
			(name.isDirectory() ? "is a diectory":"is not absolute path"), 
			(name.isAbsolute()? "is absolute path":"is not absolute path"),
			"Last modified: ",name.lastModified(),"Length: ",name.length(), "Path: ",name.getPath(),"Absolute path: ",name.getAbsolutePath(),"Parent: ",name.getParent() ));
